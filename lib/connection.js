...
module.exports = (function() {
  ...
  DbHelper.prototype.join = function(collection, criteria, cb) {
    ...
    _.each(cjoins, function(join) {
      console.log(join);
      ret += ', "' + join.alias + '" : (FOR ' + join.alias + ' IN NEIGHBORS(' +
          aqb.str(join.parent).toAQL() + ',' + aqb.str(join.alias + 'Of').toAQL() + ',' +
          'd._id' + ', "any", [], ' +
          '{"includeData": true}) RETURN ' + join.alias + ')';
    });
    ret += ' }';
    console.log(qb + ret);
